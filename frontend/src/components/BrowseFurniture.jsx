      ...
      <header className="bg-dark">
        <div className="container py-3">
          ...
          <h5 className="text-white text-center mb-4">
            Home Decor for Sale - Place Where Comfort Meets Elegance
          </h5>
                      ...
                      <div className="card-body">
                        ...
                        >
                          <div class="offcanvas-header">
                            <h1
                              class="offcanvas-title display-3"
                          ...
                          <div class="offcanvas-body">
                            <h3>
                              This Furniture is currently unavilable we will
                              notify you once it comes in stock.
                              <br />
                              Thank you!
                            </h3>
                          </div>
